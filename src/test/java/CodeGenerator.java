...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://127.0.0.1:3306/mc";
    ...
    public static void main(String[] args) {
      //  genCode("address","admin","banner","category","evaluate","goods","member","order","order_goods","permissions","role","role_permissions","shopping_cart","system_message","transaction","transport_cost");
//        genCode("请输入表名");
